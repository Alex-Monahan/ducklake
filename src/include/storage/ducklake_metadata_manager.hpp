...
public:
	...
	//! Format a row ID for SQL generation - can be overridden for stored procedure placeholder support
	virtual string FormatRowId(TableIndex table_id, optional_idx row_id_start, optional_idx row_id_offset);

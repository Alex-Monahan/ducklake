...
DuckLakeMultiFileList::DuckLakeMultiFileList(DuckLakeFunctionInfo &read_info,
    ...
    : MultiFileList({}, FileGlobOptions::ALLOW_EMPTY), read_info(read_info), read_file_list(false),
...
DuckLakeMultiFileList::DuckLakeMultiFileList(DuckLakeFunctionInfo &read_info,
    ...
    : MultiFileList({}, FileGlobOptions::ALLOW_EMPTY), read_info(read_info), files(std::move(files_to_scan)),
      read_file_list(true) {
}

DuckLakeMultiFileList::DuckLakeMultiFileList(DuckLakeFunctionInfo &read_info,
                                             const DuckLakeInlinedTableInfo &inlined_table)
    : MultiFileList({}, FileGlobOptions::ALLOW_EMPTY), read_info(read_info), read_file_list(true) {
